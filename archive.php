            ...
            <div class="wrap_float grid">
                <?php if ($this->have()): ?>
                    <div class="waterfalls">
                        <?php while ($this->next()): ?>
                            <div class="box">
                                <div class="pic" href='<?php $this->permalink() ?>'>
                                    <img src="<?php $this->options->themeUrl('./assets/img/loading.gif'); ?>"
                                         data-src="<?php echo thumb($this); ?>" class="lazyload post-bg-img"/>
                                    <div class="widget">
                                        <div class="post-tags">
                                            <div class="tag">
                    ...
                    <center>
                        <svg width="250px" height="251px" viewBox="0 0 250 251" version="1.1"
                            ...
                            <g id="页面-1-" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="公共页面" transform="translate(-1032.000000, -2471.000000)">
                                    <g id="编组-44" transform="translate(782.000000, 2134.000000)">
                                        <g id="编组-25" transform="translate(250.000000, 337.000000)">
                                            <circle id="椭圆形" fill="url(#linearGradient-1)" cx="125" cy="126"
                                                    r="125"></circle>
                                            <g id="编组-23备份-3" opacity="0.281133743"
                                               transform="translate(20.000000, 58.000000)">
                                                <polygon id="矩形" fill="url(#linearGradient-2)"
                                                         points="21 30.6382979 42 20 42 59.3617021 21 70"></polygon>
                                                <polygon id="矩形" fill="url(#linearGradient-3)"
                                                ...
                                                <polygon id="矩形备份-5" fill="url(#linearGradient-4)"
                                            ...
                                            <g id="编组-23备份-4" opacity="0.281133743"
                                               transform="translate(91.000000, 5.000000)">
                                                <polygon id="矩形" fill="url(#linearGradient-5)"
                                                         points="27 38.6170213 54 25 54 75.3829787 27 89"></polygon>
                                                <polygon id="矩形" fill="url(#linearGradient-6)"
                                                ...
                                                <polygon id="矩形备份-5" fill="url(#linearGradient-7)"
                                            ...
                                            <circle id="椭圆形" fill="url(#radialGradient-8)" cx="117" cy="17"
                                                    r="17"></circle>
                                            <g id="编组-23备份-5" opacity="0.281133743"
                                               transform="translate(193.000000, 82.000000)">
                                                <polygon id="矩形" fill="url(#linearGradient-9)"
                                                         points="19 27.787234 38 18 38 54.212766 19 64"></polygon>
                                                <polygon id="矩形" fill="url(#linearGradient-10)"
                                                ...
                                                <polygon id="矩形备份-5" fill="url(#linearGradient-11)"
                                            ...
                                            <polygon id="路径-7" fill="url(#linearGradient-12)"
                                                     opacity="0.645252046"
                                                     points="130.3867 120.871317 219.5 151.050408 162.914043 184.080183 119 138.605855"></polygon>
                                            <g id="编组-23备份-5" transform="translate(63.000000, 58.000000)">
                                                <polygon id="矩形" fill="url(#linearGradient-13)"
                                                         points="57 83.3617021 114 54 114 118.638298 57 148"></polygon>
                                                <g id="钱-" transform="translate(77.000000, 89.000000)"
                                                   fill="#DCDCDC" fill-rule="nonzero">
                                                ...
                                                <polygon id="矩形" fill="url(#linearGradient-14)"
                                            ...
                                            <polygon id="路径-5" fill="url(#linearGradient-16)"
                                                     points="63 112 41 138.638298 100 173 120 141.361702"></polygon>
                                            <polygon id="路径-6" fill="#C3C3C3"
                                            ...
                                            <path d="M114.686282,113.774093 C98.8954274,111.521112 91,102.187778 91,85.7740928 C91,61.1535646 119.619867,63.1039062 125.96515,74.4389995 C132.310432,85.7740928 94.0849618,84.4616779 108.482575,56.7857788 C109.883877,54.6276604 111.95178,52.6990675 114.686282,51"
                                                  id="路径-8" stroke="#D1CECE" stroke-width="2"
