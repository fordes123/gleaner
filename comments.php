        ...
        <div class="comment-item">
            ...
            <div id="<?php $comments->theId(); ?>">
                ...
                <div class="comment-item-userpic">
                    <img class="lazy image-cover" src="<?php $options->themeUrl('./assets/img/avatar/default.png'); ?>"
                         data-src="<?php Gravatar($comments->mail); ?>" error-src="<?php fallbackGravatar(); ?>"
                         alt=""/>
                </div>
...
<div class="comments-section" id="comments-section">
    <div class="wrap wrap-center">
        <div class="wrap_float">
            ...
            <h2 id="response" class="title">评论区 <span
                        class="comments-count"><?php $this->commentsNum(_t('0'), _t('1'), _t('%d')); ?></span><?php if (!$this->allow('comment')): ?>
                    <span class="comments-count">已关闭评论</span><?php endif; ?>
                <?php if ($this->user->hasLogin()): ?>
                    <a href="<?php $this->options->profileUrl(); ?>">
                        <img class="lazy img-svg" style="margin-bottom:-10px;border-radius:50px;width:50px;height:50px"
                             src="<?php $this->options->themeUrl('./assets/img/avatar/default.png'); ?>"
                             data-src="<?php Gravatar($this->user->mail); ?>" error-src="<?php fallbackGravatar(); ?>"
                             alt=""/>
                    </a>
                <?php endif; ?>
            </h2>
                        ...
                        <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                            ...
                            <div class="comments-form">
                                <div class="input-wrap textarea-wrap white-label comment-field"
                                    ...
                                    <textarea name="text" id="textarea" class="input textarea" placeholder="撰写评论"
                        ...
                        <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                            ...
                            <div class="comments-form">
                                ...
                                <div class="input-wrap white-label name-field" style="margin-bottom:15px">
                                    <input type="text" name="author" id="author" class="input" placeholder="称呼*"
                                           value="<?php $this->remember('author'); ?>" required/>
                                </div>
                                <div class="input-wrap white-label email-field" style="margin-bottom:15px">
                                    <input type="email" name="mail" id="mail" class="input" placeholder="邮箱*"
